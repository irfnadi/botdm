...
const freefire = require("./lib/freefire.js")
//
const BotName = 'BangCin BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/irfnadi'; // Nama Instagramlu cok
const whatsapplu = '0858-1105-4157'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'Cuma Bisa Di Grup Ini!'; // OFFICIAL GRUP LU 1
const grupch2 = 'Cuma Bisa Di Grup Ini!'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, freefire.freefire(id, BotName, corohelp, tampilTanggal, tampilWaktu, instagramlu, whatsapplu, kapanbotaktif, grupch1, grupch2) ,MessageType.text);
}
else if (text == '#DONASI'){
  const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
